    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <h2>Ajouter un domaine de competence</h2>
...
@endif
        <form  action="{{ route('domaine.store') }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            <div class="form-group">
                <label for="nom">Nom du domaine de compétence:</label>
                <input type="text" name="nom" id="nom" class="form-control" placeholder="nom du domaine de competence" required>
                @if ($errors->has('nom'))
