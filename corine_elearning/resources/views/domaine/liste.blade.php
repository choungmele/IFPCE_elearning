...
<h1 style="text-align:center">Liste des domaines de compétences</h1>
@if(session('message'))
          ...
          {{-- <table id="table" class="table table-striped table-responsive mt-3 col-lg-12 bg-white fs-sm"
              ...
              <thead class="bg-black-10">
                  <tr class="text-uppercase text-center ">
                      ...
                      <th class="fw-medium">Nom du domaine de compétences</th>
                  ...
                  @foreach ($domaines as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              ...
                              <div class="btn-group">
                                  <a href="{{ route('domaine.modifier', $item->id) }}" data-bs-toggle="modald"
                                  ...
                                  <a href="{{ route('domaine.supprimer', $item->id) }}">
