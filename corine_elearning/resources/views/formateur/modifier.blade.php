    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <h2>Entrez les nouvelles informations ici</h2>
...
<div class="container">
        ...
        @endif
        <form  action="{{ route('formateur.store_modif', $format->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            <div class="form-group">
                <label for="nom">Nom :</label>
                <input type="text" name="nom" id="nom" class="form-control"  value="{{ $format->nom}}" required>
                @if ($errors->has('nom'))
            ...
            <div class="form-group">
                ...
                <input type="text" name="prenom" id="prenom"  class="form-control"  value="{{ $format->prenom}}" required>
            </div>
            <div class="form-group">
                <label for="naissance">Date de naissance :</label>
                <input type="date" name="naissance" id="naissance" class="form-control"  value="{{ $format->naissance}}" required>
            </div>
            <div class="form-group">
                <label for="cni">Numéro de CNI :</label>
                <input type="number" name="cni" id="cni" class="form-control" value="{{ $format->cni}}" required>
            </div>
            <div class="form-group">
                <label for="cni">Numéro de téléphone :</label>
                <input type="number" name="tel" id="tel" class="form-control" value="{{ $format->tel}}" required>
            </div>
            <div class="form-group">
                <label for="ville">Ville :</label>
                <input type="text" name="ville" id="ville" class="form-control" value="{{ $format->ville}}" required>
            </div>
            <div class="form-group">
                <label for="quartier">Quartier :</label>
                <input type="text" name="quartier" id="quartier" class="form-control" value="{{ $format->quartier}}"required>
            </div>
            <div class="form-group">
                <label for="ville">Domaine de compétence :</label>
                <select class="js-select2 form-select" id="domaine" name="domaine" style=""
            ...
            <div class="form-group">
                ...
                <input type="email" name="mail" id="mail" class="form-control" value="{{ $format->email}}" required>
            </div>
            <div class="form-group">
                <label for="password">Mot de passe :</label>
                <input type="text" name="password" id="password" class="form-control" value="{{ $format->password}}" required>
            </div>
