...
.cadre {
    display: flex;
    flex-wrap: wrap;
    max-height: 250px; /* Hauteur maximale pour afficher les éléments */
...
@endif
            ...
            @foreach($formateurs as $formateur)
                                    ...
                                    <div class="photo">
                                            <img src="{{ asset('storage/' .$formateur->photo) }}" alt="Photo de profil"  style="width:390px; height: 290px;  border-radius: 21px;"> 
                                                <div class="informations">
                                                    <h2>{{ $formateur->nom }} </h2>
                                                    <h3>{{ $formateur->prenom }}</h3>
                                                    <p>{{ $formateur->naissance }}</p>
                                                    <p>{{ $formateur->domaine }}</p>
                                                    <p>{{ $formateur->cni }}</p>
                                                    <p>{{ $formateur->ville }}</p>
                                                    <p>{{ $formateur->quartier }}</p>
                                                    <p>{{ $formateur->tel }}</p>

                                                    <div class="b">
                                        
                                                    <a href="{{ route('formateur.supprimer', $formateur->id) }}">
                                  ...
                                  <a href="{{ route('formateur.modifier', $formateur->id) }}">
