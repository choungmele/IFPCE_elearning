...
<div class="container">
        ...
        @endif
        <form  action="{{ route('formateur.store') }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" name="cni" id="cni" class="form-control" required>
            </div>
            <div class="form-group">
