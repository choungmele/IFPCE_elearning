...
<div class="container">
        ...
        @endif
        <form  action="{{ route('examen.store') }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="js-select2 form-select" id="session" name="session" style=""
                                data-container="#modal-block-select2" data-placeholder="id-code-nom-marque">
                ...
                <input type="date" name="delais" id="delais" class="form-control"  required>
