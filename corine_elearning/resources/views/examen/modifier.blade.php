...
<div class="container">
        ...
        @endif
        <form  action="{{ route('examen.store_modif', $exam->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            <div class="form-group">
                <label for="titre">Titre de l'examen :</label>
                <input type="text" name="titre" id="titre" class="form-control" value="{{ $exam->titre }}" required>
                
            </div>

            <div class="form-group">
                <label for="specialite">Spécialité :</label>
                <select class="js-select2 form-select" id="specialite" name="specialite" style="" value="{{ $exam->specialite }}"
                ...
                <select class="js-select2 form-select" id="formateur" name="formateur" style="" value="{{ $exam->formateur }}"
                                data-container="#modal-block-select2" data-placeholder="id-code-nom-marque">
                ...
                <select class="js-select2 form-select" id="session" name="session" style="" value="{{ $exam->session }}"
                                data-container="#modal-block-select2" data-placeholder="id-code-nom-marque">
                                ...
                                <div class="form-group">
                <label for="delais">Délais de remise :</label>
                <input type="date" name="delais" id="delais" class="form-control" value="{{ $exam->delais }}" required>
