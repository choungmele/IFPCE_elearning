...
<h1 style="text-align:center">Liste des examens créés</h1>
                  ...
                  @foreach ($examen as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              ...
                              <div class="btn-group">
                                  <a href="{{ route('examen.edit', $item->id) }}" data-bs-toggle="modald"
                                  ...
                                  <a href="{{ route('examen.delete', $item->id) }}">
                                  ...
                                  <a href="{{ route('examen.publier', $item->id) }}">
