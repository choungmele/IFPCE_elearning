                ...
                <div class="container text-center">
                    <div class="row align-items-start">
                      <div class="col s12">
                        ...
                        @endif
                        <a href="/ajouterF" class="btn btn-primary">Ajouter un formateur</a>
                            ...
                            <tbody>
                              ...
                              @foreach ($formateurs as $formateur)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/updateF-formateur/{{ $formateur->id }}" class="btn btn-info">Update</a>
                                        <a href="/deleteF-formateur/{{ $formateur->id }}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                                @php
                                $ide += 1;
