...
<body>
    <img src="{{ asset('images/brochure.jpg') }}" alt="brochure" width="1520px" height="160px"/>
                    ...
                    <div class="row align-items-start">
                      <div class="col s12">
                        ...
                        <form action="/updateF/traitement" method="POST" class="form-group">
                          @csrf
                          <input type="text" name="id" style="display:none; " value="{{$formateurs->id}}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="Classe" name="classe"  value="{{$formateurs->classe}}">
                          </div> 
                          <button type="submit" class="btn btn-primary">modifier un  formateur</button>
                          <br><br>
                          <a href="/listeF" class="btn btn-danger">Revenir a la liste des formateurs</a>
                        </form>
                      </div>
                    </div>
                  </div>
