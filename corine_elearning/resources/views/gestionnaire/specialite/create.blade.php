...
@endif
        <form  action="{{ route('specialite.store') }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf

            <div class="form-group">
                <label for="code">Code de la specialite:</label>
                <input type="text" name="code" id="code" class="form-control" placeholder="code de la specialité" required>
                @if ($errors->has('code'))
                        <small class="mb-0 text-danger">{{ $errors->first('code') }}</small>
                    @endif
            </div>
            <div class="form-group">
                <label for="nom">Nom de la specialite:</label>
                <input type="text" name="nom" id="nom" class="form-control" placeholder="nom de la specialité" required>
                @if ($errors->has('nom'))
