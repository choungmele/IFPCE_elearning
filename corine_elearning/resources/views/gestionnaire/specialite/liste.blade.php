...
<h1 style="text-align:center">Liste des spécialités</h1>
@if($errors->any())
          ...
          {{-- <table id="table" class="table table-striped table-responsive mt-3 col-lg-12 bg-white fs-sm"
              ...
              <thead class="bg-black-10">
                  <tr class="text-uppercase text-center ">
                      ...
                      <th class="fw-medium">Code de la specialité</th>
                      <th class="fw-medium">Nom de la spécialité</th>
                  ...
                  @foreach ($specialites as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              ...
                              <div class="btn-group">
                                  <a href="{{ route('specialite.modifier', $item->id) }}" data-bs-toggle="modald"
                                  ...
                                  <a href="{{ route('specialite.supprimer', $item->id) }}">
