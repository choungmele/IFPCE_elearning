    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <h2>Modifier la specialite ici</h2>
...
@endif
        <form  action="{{ route('specialite.store_modif' , $spec->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            <div class="form-group">
                <label for="code">Code de la session:</label>
                <input type="text" name="code" id="code" class="form-control" placeholder="Code de la specialite" value="{{ $spec->code }}"required>
                @if ($errors->has('code'))
            ...
            <div class="form-group">
                ...
                <input type="text" name="nom" id="nom" class="form-control" placeholder="nom du domaine de competence" value="{{ $spec->nom }}"required>
                @if ($errors->has('nom'))
