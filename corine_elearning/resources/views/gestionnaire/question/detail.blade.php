...
<h1 style="text-align:center">Liste des question du quizz {{$quiz->titre}}</h1>
          ...
          {{-- <table id="table" class="table table-striped table-responsive mt-3 col-lg-12 bg-white fs-sm"
              ...
              <thead class="bg-black-10">
                  <tr class="text-uppercase text-center ">
                      ...
                      <th class="fw-medium">choix 1</th>
                      <th class="fw-medium">choix 2</th>
                      <th class="fw-medium">choix 3 </th>
                      <th class="fw-medium">choix 4 </th>
                      <th class="fw-medium">reponse correcte  </th>
                  ...
                  @foreach ($questions as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              <span class="">{{ $item->choix_3 }}</span>
                          </td>

                          <td class="text-center">
                              <span class="">{{ $item->choix_4 }}</span>
                          </td>
