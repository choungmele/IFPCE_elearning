      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <!-- Contenu de la page -->
                <h1 style="text-align:center">Liste des examens rendu</h1>
          ...
          {{-- <table id="table" class="table table-striped table-responsive mt-3 col-lg-12 bg-white fs-sm"
              ...
              <thead class="bg-black-10">
                  <tr class="text-uppercase text-center ">
                      ...
                      <th class="fw-medium">Titre de l'examen</th>
                      <th class="fw-medium">session</th>
                      <th class="fw-medium">Nom de l'apprenant</th>
                      <th class="fw-medium">date de remise </th>
                  ...
                  @foreach ($examens as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              <span class="">{{ $item->nom_apprenant }}</span>
                          </td>
