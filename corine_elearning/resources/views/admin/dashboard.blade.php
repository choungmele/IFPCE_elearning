      ...
      <div class="container-fluid">
        <div class="row">
                ...
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('gestionnaire.liste') }}"><i class="fa fa-list" aria-hidden="true"></i>Liste des gestionnaires</a></li>
                                <li><a class="dropdown-item" href="{{ route('gestionnaire.create') }}"><i class="fa fa-user-plus" aria-hidden="true"></i>Ajouter un gestionnaire</a></li>   
                             </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <!-- Contenu de la page -->
                <h2>tableau de bord de admin</h2>
                <!-- ... -->
            </main>
        </div>
    </div>
