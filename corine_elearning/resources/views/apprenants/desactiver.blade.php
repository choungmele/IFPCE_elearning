...
.table-container {
  overflow-x: auto;
  white-space: nowrap;
  animation: scroll 20s linear infinite; /* Remplacez 20s par la durée souhaitée pour une itération complète */
}
...
<h1 style="text-align:center">Liste des comptes desactivés</h1>
...
<div class="container">
      ...
      data-dismiss="true" class="block block-rounded table table-bordered table-striped table-vcenter " class="table-container">
          ...
          {{-- <table id="table" class="table table-striped table-responsive mt-3 col-lg-12 bg-white fs-sm"
              ...
              <thead class="bg-black-10">
                  <tr class="text-uppercase text-center ">
                      ...
                      <th class="fw-medium">Prénom</th>
                      <th class="fw-medium">Date de naissance</th>
                      <th class="fw-medium">Lieu de naissance</th>
                      <th class="fw-medium">Pays de résidence</th>
                      <th class="fw-medium">Ville de résidence</th>
                      <th class="fw-medium">Numéro de téléphone</th>
                      <th class="fw-medium">Adresse e-mail</th>
                      <th class="fw-medium">Numéro de cni</th>
                      <th class="fw-medium">Spécialité</th>
                      <th class="fw-medium">Numéro d'inscription</th>
                      <th class="fw-medium">Nom de la personne à contacter</th>
                      <th class="fw-medium">Téléphone de la personne à contacter</th>
                      <th class="fw-medium">Lien de parenté</th>
                  ...
                  @foreach ($data as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              <span class="">{{ $item->naissance }}</span>
                          </td>
                          ...
                          <td class="text-center">
                              ...
                              <div class="btn-group">
                                  <a href="{{ route('apprenant.modifier', $item->id) }}" data-bs-toggle="modald"
                                      name="add" data-bs-target="#fmodal-default-extra-large"
                                      class="btn btn-primary push btn-sm add" title="Modifier">
                                      <i class="fas fa-check"></i>
                                  </a>&nbsp;



                                  <a href="{{ route('apprenant.show_activer', $item->id) }}">
                                  ...
                                  <a href="{{ route('apprenant.show_supprimer', $item->id) }}">
