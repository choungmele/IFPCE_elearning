    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <h2>Modifier les informations ici</h2>
...
@endif
        <form  action="{{ route('apprenant.store_modif' , $apps->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf

            <div class="form-group">
            <label for="nom" class="lab">Nom</label>
            <input type="text" name="nom" placeholder="nom" class="form-control" required id="nom" value="{{ $apps->nom }}" >
            @if ($errors->has('email'))
    ...
    <div class="form-group">
            ...
            <input type="text" name="prenom" placeholder="Prénom" class="form-control"  required value="{{ $apps->prenom }}" id="prenom">
    ...
    <div class="form-group">
            ...
            <input type="date" name="naissance" placeholder="Date de naissance" class="form-control" value="{{ $apps->naissance }}" required id="naissance" >
            @if ($errors->has('email'))
                        <small class="mb-0 text-danger">{{ $errors->first('email') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="text" name="lieu" placeholder="Lieu de naissance" class="form-control" value="{{ $apps->lieu }}" required id="lieu">
            @if ($errors->has('password'))
                        <small class="mb-0 text-danger">{{ $errors->first('password') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="text" name="pays" placeholder="Pays de résidence" class="form-control" value="{{ $apps->pays }}" required id="pays" >
            @if ($errors->has('email'))
                        <small class="mb-0 text-danger">{{ $errors->first('email') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="text" name="ville" placeholder="Ville de résidence " class="form-control" value="{{ $apps->ville }}" required id="ville">
            @if ($errors->has('password'))
                        <small class="mb-0 text-danger">{{ $errors->first('password') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="number" name="tel" placeholder="Numéro de téléphone" class="form-control"  value="{{ $apps->tel }}" required id="tel" >
            @if ($errors->has('email'))
                        <small class="mb-0 text-danger">{{ $errors->first('email') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="password" name="password" placeholder="Password" class="form-control" value="{{ $apps->password }}" required id="password">
            @if ($errors->has('password'))
                        <small class="mb-0 text-danger">{{ $errors->first('password') }}</small>
                    @endif
    </di>
    <div class="form-group">
            ...
            <input type="email" name="email" placeholder="Email" class="form-control" required value="{{ $apps->email }}" id="email" >
            @if ($errors->has('email'))
                        <small class="mb-0 text-danger">{{ $errors->first('email') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="number" name="cni" placeholder="Numéro de la cni/passport" class="form-control" value="{{ $apps->cni }}" required id="cni" >
            @if ($errors->has('email'))
                        <small class="mb-0 text-danger">{{ $errors->first('email') }}</small>
                    @endif
    </div>
    <div class="form-group">
                ...
                <select class="js-select2 form-select" id="specialite" name="specialite" class="form-control"  >
    ...
    <div class="form-group">
            ...
            <input type="number" name="inscription" placeholder="Numéro de telephone whatsapp" class="form-control" value="{{ $apps->inscription }}" required id="inscription" >
            @if ($errors->has('email'))
                        <small class="mb-0 text-danger">{{ $errors->first('email') }}</small>
                    @endif 
    </div>
    <div class="form-group">
            ...
            <input type="text" name="personne" placeholder="Nom de la personne a contcter" class="form-control" value="{{ $apps->personne }}" required id="personne">
            @if ($errors->has('password'))
                        <small class="mb-0 text-danger">{{ $errors->first('password') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="number" name="tel_pers" placeholder="Téléphone de la personne à contacter" class="form-control"value="{{ $apps->tel_pers }}" required id="tel_pers" >
            @if ($errors->has('email'))
                        <small class="mb-0 text-danger">{{ $errors->first('email') }}</small>
                    @endif
    </div>
    <div class="form-group">
            ...
            <input type="text" name="lien" placeholder="Lien de parenté" value="{{ $apps->lien }}" class="form-control" required id="lien">
            @if ($errors->has('password'))
                        <small class="mb-0 text-danger">{{ $errors->first('password') }}</small>
                    @endif
    </div>
    ...
    margin: 0 auto; margint-top:20px;">Enregistrer</button>
        </form>
    </div>
