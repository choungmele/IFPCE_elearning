    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <h2>Vous etes sur le point de valider cette candidature </h2>
...
<div class="container">
        ...
        @endif
        <form  action="{{ route('mail.valider', $app->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            
            <div class="form-group">
            <label for="message">Tapez votre message :</label><br>
