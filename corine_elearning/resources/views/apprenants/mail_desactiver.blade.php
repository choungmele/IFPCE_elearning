    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <h2>Vous etes sur le point de desactiver ce compte</h2>
...
<div class="container">
        ...
        @endif
        <form  action="{{ route('apprenant.desactiver', $app->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf

            <div class="form-group">
            <label for="message">Entrez le motif de la desactivation :</label><br>
