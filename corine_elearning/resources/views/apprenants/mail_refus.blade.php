    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
            ...
            <h2>Vous etes sur le point de rejeter cette candidature</h2>
...
<div class="container">
        ...
        @endif
        <form  action="{{ route('mail.refuser', $app->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf

            <div class="form-group">
            <label for="message">Entrez le motif du refus :</label><br>
