...
<h1 style="text-align:center">Liste des postulants</h1>
                  ...
                  @foreach ($data as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              ...
                              <div class="btn-group">
                                  <a href="{{ route('mail.show_valider', $item->id) }}" data-bs-toggle="modald"
                                      name="add" data-bs-target="#fmodal-default-extra-large"
                                      class="btn btn-primary push btn-sm add" title="valider">
                                      <i class="fas fa-check"></i>
                                  </a>&nbsp;



                                  <a href="{{ route('mail.show_refuser', $item->id) }}">
