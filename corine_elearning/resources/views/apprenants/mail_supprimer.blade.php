    ...
    <nav class="navbar bg-body-tertiary">
      ...
      <div class="container-fluid">
        ...
        <nav class="col-md-2 d-none d-md-block sidebar">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="{{ route('examen.liste_examen_envoyé', $gestionnaire->id) }}">Liste des examens envoyés</a></li>
                            </ul>
                        </li>
            ...
            <h2>Vous etes sur le point de supprimer ce compte</h2>
...
<div class="container">
        ...
        @endif
        <form  action="{{ route('apprenant.supprimer', $app->id) }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf

            <div class="form-group">
            <label for="message">Entrez le motif de la suppression :</label><br>
    <textarea name="message" id="message" rows="10" class="form-control" required></textarea><br>
            </div>


           
            <button type="submit" class="btn btn-primary" style=" display: block;
    margin: 0 auto; margin-bottom:100px;">Envoyer</button>
        </form>
    </div>
