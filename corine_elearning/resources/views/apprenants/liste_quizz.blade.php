                ...
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('apprenant.liste_examen', $app->id ) }}"><i class="fas fa-book icon"></i>Mes examens</a></li>
                                <li><a class="dropdown-item" href="#">Rattrapage</a></li>
                              </ul>
                        </li>
                      ...
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              ...
                              <div class="btn-group">
                                  ...
                                  <a href="{{ route('apprenant.composer', ['id' => $item->id, 'id_app' => $app->id] ) }}">
