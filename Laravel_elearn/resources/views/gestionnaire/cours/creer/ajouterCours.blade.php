  ...
  <div class="container-fluid">
    <div class="row">
        ...
        <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <div class="container">
                    <div class="row align-items-start">
                      <div class="col s12">
                        ...
                        <form action="/creer/ajouterCours/traitement" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur" class="form-group">
                          @csrf
                ...
                <select class="js-select2 form-select" id="specialite" name="specialite" style=""
                                data-container="#modal-block-select2" data-placeholder="id-code-nom-marque">
                            ...
                            <div class="form-group">
                <label for="ville">Formateur :</label>
                <select class="js-select2 form-select" id="formateur" name="formateur" style=""
    data-container="#modal-block-select2" data-placeholder="--nom-prenom--">
    @foreach($formateurs as $formateur)
        <option value="{{ $formateur->nom }} {{ $formateur->prenom }}">{{ $formateur->nom }} {{ $formateur->prenom }}</option>
    @endforeach
</select>
          </div>
                       ...
                       <!--
                         <div class="form-group">
                              <label for="moduleRattachement" class="form-label">Module Rattachement</label>
                              <input type="text" class="form-control" id="moduleRattachement" name="moduleRattachement">
                          </div>
                        -->
                          <div class="form-group">
                            <label for="moduleRattachement">Module Rattachement :</label>
                            <select name="moduleRattachement" class="form-control">
                                @foreach ($modules as $ModuleSpecialite)
                                    <option value="{{ $ModuleSpecialite->nom }}">{{ $ModuleSpecialite->nom }}</option>
                                @endforeach
                            </select>
                        </div>
...
<!-- ... existing form fields ... -->
                          ...
                          <div class="form-group">
                            <label for="intituleCours" class="form-label">intitule cours</label>
                        ...
                        -->
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="volumeHoraire" name="volumeHoraire">
                          </div> 
                          <div class="form-group">
