        ...
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <div class="container mt-5">
                    <form action="/publier/upload" method="post" enctype="multipart/form-data">
                        @csrf
                ...
                <select class="js-select2 form-select" id="specialite" name="specialite" >
                        ...
                        <div class="form-group">
                            <label for="document">Sélectionnez un document:</label>
                            <input type="file" class="form-control-file" name="document" accept=".pdf, .docx, .xlsx, .mp3, .mp4, .png, .jpg">
                        </div>
