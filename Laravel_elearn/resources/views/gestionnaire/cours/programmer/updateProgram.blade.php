                ...
                <div class="container">
                    <div class="row align-items-start">
                      <div class="col s12">
                        ...
                        <form action="/programmer/updateProgram/traitement" method="POST" class="form-group">
                          @csrf
                          <input type="text" name="id" style="display:none; " value="{{$programmations->id}}">
                          <div class="form-group">
                            <label for="Session" class="form-label">Session</label>
                            <select class="form-control" id="Session" name="session">
                                @foreach ($sessions as $session)
                                    <option value="{{ $session->id }}" {{ $programmations->session_id == $session->id ? 'selected' : '' }}>
                                        {{ $session->nom }}
                                    </option>
                                @endforeach
                            </select>
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control" id="Specialite" name="specialite">
                                @foreach ($specialites as $specialite)
                                    <option value="{{ $specialite->id }}" {{ $programmations->specialite_id == $specialite->id ? 'selected' : '' }}>
                                        {{ $specialite->nom }}
                                    </option>
                                @endforeach
                            </select>
                          ...
                          <div class="form-group">
                            <label for="intituleCours" class="form-label">Specialite</label>
                            <select class="form-control" id="intituleCours" name="intituleCours">
                                @foreach ($courss as $cours)
                                    <option value="{{ $cours->id }}" {{ $courss->cours_id == $cours->id ? 'selected' : '' }}>
                                        {{ $cours->intituleCours }}
                                    </option>
                                @endforeach
                            </select>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="code" name="code"  value="{{$programmations->code}}">
                          </div>
                          <div class="form-group">
                            <label for="formateur" class="form-label">Nom du formateur</label>
                            <input type="text" class="form-control" id="formateur" name="formateur"  value="{{$programmations->formateur}}">
                          </div>
                          <div class="form-group">
                            <label for="formateurs" class="form-label">Nom du formateur 2</label>
                            <input type="text" class="form-control" id="formateurs" name="formateurs"  value="{{$programmations->formateurs}}">
                          </div>
                          <div class="form-group">
                            <label for="volumeHoraire" class="form-label">volume horaire</label>
                            <input type="text" class="form-control" id="volumeHoraire" name="volumeHoraire"  value="{{$programmations->volumeHoraire}}">
                          </div>
                          <div class="form-group">
                            <label for="debut" class="form-label">Debut seance</label>
                            <input type="text" class="form-control" id="debut" name="debut"  value="{{$programmations->debut}}">
                          </div>
                          <div class="form-group">
                            <label for="fin" class="form-label">Fin seance</label>
                            <input type="text" class="form-control" id="fin" name="fin"  value="{{$programmations->fin}}">
                          </div>
                    
                          <div class="form-group">
                            <label for="observations" class="form-label">observations</label>
                            <input type="text" class="form-control" id="observations" name="observations"  value="{{$programmations->observations}}">
                          </div> 
                          <button type="submit" class="btn btn-primary">modifier un  cours</button>
                          <br><br>
                          <a href="/programmer/listeProgram" class="btn btn-danger">Revenir a la liste des cours</a>
                        </form>
                      </div>
                    </div>
                  </div>
