        ...
        <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <div class="container">
                    <div class="row align-items-start">
                      <div class="col s12">
                        <h1>Programmation d'un cours</h1>
                        <hr>
                        ...
                        <form action="/programmer/ajouterProgram/traitement" method="POST" class="form-group">
                          @csrf
                      ...
                      <div class="form-group">
                        <label for="intituleCours">Nom du cours :</label>
                        <select name="intituleCours" class="form-control">
                            @foreach ($courss as $cours)
                                <option value="{{ $cours->intituleCours }}">{{ $cours->intituleCours }}</option>
                            @endforeach
                        </select>
                     </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="formateurs" name="formateurs">
                          </div>
...
<script>
    $(document).ready(function() {
        $('#intituleCours').change(function() {
            var intituleCours = $(this).val();
            $.ajax({
                url: '{{ route("get-code") }}',
                method: 'GET',
                data: {intituleCours: intituleCours},
                ...
                <!-- ... -->
                <!-- resources/views/programmation_cours/create.blade.php -->
