      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <div class="container">
                    <h2>Synthèse des cours planifiés</h2>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Formateur</th>
                                <th>Nombre de séances</th>
                                <th>Temps total planifié (en heures)</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($syntheseCours as $synthese)
                            <tr>
                                <td>{{ $synthese->formateur }}</td>
                                <td>{{ $synthese->nombre_seances }}</td>
                                <td>{{ $synthese->temps_total_heures }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
