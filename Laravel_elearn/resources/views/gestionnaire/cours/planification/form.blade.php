      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                <!-- Contenu de la page -->
                <h2>PLANIFICATION D'UN COURS</h2>
                <!-- resources/views/cours/planification/form.blade.php -->

                <div class="container mt-5">
                    <form action="/planification/store" method="post">
                        @csrf
                
                        <div class="form-group">
                            <label for="seance">Séance :</label>
                            <input type="number" class="form-control" name="seance" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="formateur_assistant" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="jour" required>
                        </div>
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary">Planifier le cours</button>
                    </form>
                </div>
