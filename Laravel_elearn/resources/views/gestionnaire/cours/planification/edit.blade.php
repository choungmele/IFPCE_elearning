      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <!-- resources/views/gestionnaire/cours/planification/edit.blade.php -->
                <h1>Edit Planification</h1>

                <!-- Your form and other content go here -->
                <form action="{{ url('/planification/update', $coursPlanification->id) }}" method="post">
                    @csrf
                    @method('PUT')
                
                    <div class="form-group">
                        <label for="seance">Séance :</label>
                        <input type="text" class="form-control" name="seance" value="{{ $coursPlanification->seance }}">
                    </div>
                
                    <div class="form-group">
                        <label for="cours">Cours :</label>
                        <input type="text" class="form-control" name="cours" value="{{ $coursPlanification->cours }}">
                    </div>
                
                    <div class="form-group">
                        <label for="formateur">Formateur :</label>
                        <input type="text" class="form-control" name="formateur" value="{{ $coursPlanification->formateur }}">
                    </div>
                
                    <div class="form-group">
                        <label for="formateur_assistant">Formateur Assistant :</label>
                        <input type="text" class="form-control" name="formateur_assistant" value="{{ $coursPlanification->formateur_assistant }}">
                    </div>
                
                    <div class="form-group">
                        <label for="site">Site :</label>
                        <input type="text" class="form-control" name="site" value="{{ $coursPlanification->site }}">
                    </div>
                
                    <div class="form-group">
                        <label for="jour">Jour :</label>
                        <input type="text" class="form-control" name="jour" value="{{ $coursPlanification->jour }}">
                    </div>
                
                    <div class="form-group">
                        <label for="heure_debut">Heure de début :</label>
                        <input type="time" class="form-control" name="heure_debut" value="{{ $coursPlanification->heure_debut }}">
                    </div>
                
                    <div class="form-group">
                        <label for="heure_fin">Heure de fin :</label>
                        <input type="time" class="form-control" name="heure_fin" value="{{ $coursPlanification->heure_fin }}">
                    </div>
