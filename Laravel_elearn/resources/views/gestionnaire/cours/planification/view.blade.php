      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <!-- resources/views/cours/planification/view.blade.php -->
    ...
    <tbody>
        @foreach($coursPlanifications as $CoursPlanification)
            <tr>
                ...
                <td>
                    <a href="{{ route('planification.edit', $CoursPlanification->id) }}" class="btn btn-primary">Modifier</a>

                    <form action="{{ route('planification.delete', $CoursPlanification->id) }}" method="post" style="display:inline;">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger" onclick="return confirm('Voulez-vous vraiment supprimer cette planification ?')">Supprimer</button>
                    </form>
                    
                    <a href="{{ route('planification.export', $CoursPlanification->id) }}" class="btn btn-success">Exporter en PDF</a>
                </td>
            </tr>
        @endforeach
    </tbody>
