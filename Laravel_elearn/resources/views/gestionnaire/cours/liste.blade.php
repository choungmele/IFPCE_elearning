...
<h1 style="text-align:center">Liste des cours créés</h1>
          ...
          {{-- <table id="table" class="table table-striped table-responsive mt-3 col-lg-12 bg-white fs-sm"
              ...
              <thead class="bg-black-10">
                  <tr class="text-uppercase text-center ">
                      ...
                      <th class="fw-medium">Objectifs</th>
                      <th class="fw-medium">Spécialité</th>
                      <th class="fw-medium">Formateur</th>
                      <th class="fw-medium">Coefficient</th>
                      <th class="fw-medium">Nombre d'eleves qui suivent</th>
                      <th class="fw-medium">Nombre de fichiers</th>
              ...
              <tbody style="font-size: 14px;font-weight: 500">
                  @foreach ($cour as $item)
                      <tr style="border: 0.2px solid #ececec; padding: 5px">
                          ...
                          <td class="text-center">
                              <span class="">{{ $item->coef }}</span>
                          </td>

                          <td class="text-center">
                              <span class="">{{ $item->suivi }}</span>
                          </td>
                          <td class="d-none d-sm-table-cell">
                          ...
                          <td class="text-center">
                              ...
                              <div class="btn-group">
                                  ...
                                  <a href="{{ route('cours.details', $item->id) }}">
                                  ...
                                  <a href="{{ route('cours.add_file', $item->id) }}">
                                  ...
                                  <a href="{{ route('cours.publier', $item->id) }}">
