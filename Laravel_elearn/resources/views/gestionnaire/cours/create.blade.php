...
<div class="container">
        ...
        @endif
        <form  action="{{ route('cours.store') }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="number" name="coef" id="coef" class="form-control" required>
            </div>
            <div class="form-group">
