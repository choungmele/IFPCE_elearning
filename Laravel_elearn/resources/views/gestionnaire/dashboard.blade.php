                ...
                <div class="sidebar-sticky">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('/communiquer') }}"><i class="fa fa-bar-chart" aria-hidden="true"></i>
                                    publication d'un communique</a></li>
                                <li><a class="dropdown-item" href="{{url('/visualiser', $data->id)}}"><i class="fa fa-bar-chart" aria-hidden="true"></i>
                                    visualiser message recu</a></li>
                                    <li><a class="dropdown-item" href="{{ url('gestionnaire_corriger') }}"><i class="fa fa-bar-chart" aria-hidden="true"></i>
                                    Liste des devoirs rendus</a></li>
                              </ul>
                        </li>
                        <li class="nav-item">
