                ...
                <div class="container">
                    <div class="row align-items-start">
                      <div class="col s12">
                        ...
                        <form action="/updateF/traitement" method="POST" class="form-group">
                            @csrf
                            <input type="hidden" name="id" value="{{$formateurs->id}}">
                            <div class="form-group">
                                <label for="Nom" class="form-label">Nom</label>
                                <input type="text" class="form-control" id="Nom" name="nom" value="{{$formateurs->nom}}">
                            </div>
                            
                            <div class="form-group">
                                <label for="Prenom" class="form-label">Prenom</label>
                                <input type="text" class="form-control" id="Prenom" name="prenom" value="{{$formateurs->prenom}}">
                            </div>
                        
                            <div class="form-group">
                                <label for="Email" class="form-label">Email</label>
                                <input type="email" class="form-control" id="Email" name="email" value="{{$formateurs->email}}">
                            </div>
                        
                            <div class="form-group">
                                <label for="DateNaissance" class="form-label">Date de Naissance</label>
                                <input type="date" class="form-control" id="DateNaissance" name="date_naissance" value="{{$formateurs->date_naissance}}">
                            </div>
                        
                            <div class="form-group">
                                <label for="Telephone" class="form-label">Numéro de Téléphone</label>
                                <input type="text" class="form-control" id="Telephone" name="telephone" value="{{$formateurs->telephone}}">
                            </div>
                        
                            <div class="form-group">
                                <label for="CoursDispense" class="form-label">Domaine de Competence</label>
                                <textarea class="form-control" id="CoursDispense" name="cours_dispense">{{$formateurs->cours_dispense}}</textarea>
                            </div>
                        
                            <div class="form-group">
                                <label for="NumeroCNI" class="form-label">Numéro CNI</label>
                                <input type="text" class="form-control" id="NumeroCNI" name="numero_cni" value="{{$formateurs->numero_cni}}">
                            </div>
                        
                            <div class="form-group">
                                <label for="DateDelivrance" class="form-label">Date de Délivrance</label>
                                <input type="date" class="form-control" id="DateDelivrance" name="date_delivrance" value="{{$formateurs->date_delivrance}}">
                            </div>
                        
                            <button type="submit" class="btn btn-primary">Modifier un formateur</button>
                            <br><br>
                            <a href="/listeF" class="btn btn-danger">Revenir à la liste des formateurs</a>
                        </form>
