                ...
                <div class="container">
                    <div class="row align-items-start">
                      <div class="col s12">
                        ...
                        <form action="/ajouterF/traitement" method="POST" class="form-group">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" class="form-control" id="CoursDispense" name="cours_dispense"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <br>
                            <button type="submit" class="btn btn-primary">Ajouter un formateur</button>
                            <br><br>
