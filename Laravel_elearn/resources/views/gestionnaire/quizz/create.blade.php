...
<div class="container">
        ...
        @endif
        <form  action="{{ route('quizz.store') }}" method="POST" enctype="multipart/form-data" id="formFormateur" name="formFormateur">
            @csrf
    ...
    @endforeach
          ...
          <div class="form-group">
                <label for="delais">delais de remise :</label>
