                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>Nom</th>
                                <th>Code</th>
                                <!-- Ajoutez d'autres entêtes pour les champs -->
                            </tr>
                        </thead>
                        <tbody>
                            @foreach($modules as $module)
                                <tr>
                                    <td>{{ $module->id }}</td>
                                    <td>{{ $module->specialite->nom }}</td>
                                    <td>{{ $module->nom }}</td>
                                    <td>{{ $module->code }}</td>
                                    <!-- Ajoutez d'autres cellules pour les champs -->
                                    <td>
                                        <!-- Ajoutez des liens ou boutons pour les actions -->
                                        <a href="{{ route('editer', $module->id) }}" class="btn btn-primary">Éditer</a>
                                        <form action="{{ route('supprimer', $module->id) }}" method="post" style="display:inline;">
                                            @csrf
                                            @method('DELETE')
