        ...
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <div class="container mt-5">
                    <h2>Éditer le Module</h2>
            
                    <form method="post" action="{{ route('mettreAJour', $module->id) }}" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
            
                        <div class="form-group">
                            <label for="specialite">Sélectionnez la spécialité :</label>
                            <select name="specialite_id" id="specialite" class="form-control" required>
                                @foreach($specialites as $specialite)
                                    <option value="{{ $specialite->id }}" {{ $module->specialite_id == $specialite->id ? 'selected' : '' }}>
                                        {{ $specialite->nom }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                Veuillez entrer le nom du module.
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback">
                                Veuillez entrer le code du module.
                            </div>
                        </div>
