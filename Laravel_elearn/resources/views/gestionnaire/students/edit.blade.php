            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <!--
                        <div class="form-group">
                            ...
                            <input type="text" id="numero_inscription" name="numero_inscription" class="form-control" value="{{ $student->numero_inscription }}" required>
                    ...
                    -->
                        <div class="form-group">
                            ...
                            <input type="text" id="nom" name="nom" class="form-control" value="{{ $student->nom }}" required>
                            <div class="invalid-feedback">
