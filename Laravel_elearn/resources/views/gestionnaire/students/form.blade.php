            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <!--
                        <div class="form-group">
                            <label for="numero_inscription">Numero d'inscription:</label>
                            <input type="text" id="numero_inscription" name="numero_inscription" class="form-control" required>
                            <div class="invalid-feedback">
                                Veuillez entrer le numéro d'inscription.
                            </div>
                        </div>
                    -->
                        <div class="form-group">
                ...
                <div class="container mt-5">
                    ...
                    <a href="{{ route('students.exportPDF') }}" target="_blank" class="btn btn-success">Exporter en PDF</a>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Nom</th>
                            ...
                            @foreach($students as $student)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('students.sendEmail', $student->id) }}" method="post" style="display:inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-primary">Envoyer par mail</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
