<!-- resources/views/sessions/create-session-form.blade.php -->
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <div class="container mt-5">
                <form action="/create-specialite-form/create-specialite" method="post" class="needs-validation" novalidate>
                    @csrf
                    <div class="form-group">
                        <label for="nom">Nom de la spécialité :</label>
                        <input type="text" name="nom" class="form-control" required>
                        <div class="invalid-feedback">
                            Veuillez entrer le nom de la spécialité.
                        </div>
                    </div>
                    <br>
                    <button type="submit" class="btn btn-primary">Créer la spécialité</button>
                </form>
