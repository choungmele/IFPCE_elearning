...
<body>
      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <!-- resources/views/gestionnaire/evaluations/examens/edit.blade.php -->

    <h1>Modifier l'examen              <a href="{{ route('examens.index') }}" class="btn btn-primary">Publier un Examen</a></h1>
    ...
    <form method="post" action="{{ route('examens.update', $examen->id) }}">
        ...
        <div class="form-group">
            ...
            <input type="datetime-local" class="form-control" id="heure_debut" name="heure_debut" value="{{ $examen->heure_debut }}" required>
        </div>

        <div class="form-group">
            <label for="heure_fin">Heure de fin :</label>
            <input type="datetime-local" class="form-control" id="heure_fin" name="heure_fin" value="{{ $examen->heure_fin }}" required>
        </div>
<br>
        <button type="submit" class="btn btn-primary">Modifier l'examen</button>
    </form>
