...
<body>
    ...
    <h1>Liste des Examens                 <a href="{{ route('examens.index') }}" class="btn btn-primary">Publier un Examen</a></h1>
<br>
    <div class="mosaic-container">
    
            <div class="examen-card">
            
               <h2>{{ $examen->filename }}</h2>
               <p>Heure de début : {{ $examen->heure_debut}}</p>
                <p>Heure de fin : {{ $examen->heure_fin }}</p>

            <!-- Ajouter le lien pour télécharger l'examen -->
            <a href="{{ route('examens.download', $examen->id) }}" class="btn btn-primary">Télécharger l'examen</a>
