      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <!-- Ressources/views/examens/index.blade.php -->
                <!-- Ressources/views/votre_vue.blade.php -->

<!-- Ressources/views/votre_vue.blade.php -->
<form action="{{ route('examens.upload') }}" method="post" enctype="multipart/form-data" class="form-group">
    @csrf
    ...
    <div class="form-group">
                <label for="specialite">Sélectionnez la Spécialité :</label>
    ...
    <button type="submit" class="btn btn-primary">Charger l'examen</button>
</form>
        ...
        <tbody>
            @foreach($examens as $examen)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('examens.show', $examen->id) }}" class="btn btn-primary">Afficher</a>
