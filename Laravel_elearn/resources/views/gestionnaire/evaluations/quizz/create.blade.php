...
<!-- resources/views/quizz.blade.php -->
...
<div class="container mt-5">
    <form method="post" action="{{ route('quizz.store') }}">
        ...
        <div class="question-container">
            ...
            <div class="form-group">
                <label for="correct_answer">Bonne réponse (numéro de l'option correcte):</label>
                <input type="number" class="form-control" name="questions[0][correct_answer]" required>
            </div>
        </div>
        <br>
        <button type="button" class="btn btn-success add-question">Ajouter une question</button>
        <br>
    ...
    $(document).ready(function () {
        ...
        $(".add-question").click(function () {
            ...
            <div class="question-container">
                ...
                <div class="form-group">
                    <label for="question">Question:</label>
                    <input type="text" class="form-control" name="questions[${questionCounter}][question]" required>
                </div>
    
                <div class="form-group">
                    <label for="options">Options (séparées par des virgules):</label>
                    <input type="text" class="form-control" name="questions[${questionCounter}][options][]" required>
                    <input type="text" class="form-control" name="questions[${questionCounter}][options][]" required>
                    <input type="text" class="form-control" name="questions[${questionCounter}][options][]" required>
                    <input type="text" class="form-control" name="questions[${questionCounter}][options][]" required>
                </div>
                ...
                <div class="form-group">
                    <label for="correct_answer">Bonne réponse (numéro de l'option correcte):</label>
                    <input type="number" class="form-control" name="questions[${questionCounter}][correct_answer]" required>
                </div>
            </div>`;

            $(".question-container:last").after(questionHtml);
        });
    });
</script>
