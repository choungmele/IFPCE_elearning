      ...
      <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-lg-10 col-md-8 col-sm-12 ml-sm-auto px-md-4">
                ...
                <div class="container">
                    <h2>Ajouter une Épreuve de Rattrapage</h2>
                    ...
                    <form action="{{ route('rattrapages.store') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="file" id="file" class="form-control" required accept=".xlsx, .docx, .pptx, .pdf">
                        </div>
                        
            
                        <div class="form-group">
                            <label for="publish_at">Delai de Soumission :</label>
                            <input type="datetime-local" name="publish_at" id="publish_at" class="form-control" required>
                        </div>
                         <br>
