...
<body>
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-chalkboard-teacher icon"></i> Utilisateur
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#"><i class="fa fa-list" aria-hidden="true"></i>Liste Utilisateur</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i>Ajouter Utilisateur</a></li>   
                             </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="fas fa-chalkboard-teacher icon"></i> Gestionnaire
                            </a>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="#"><i class="fa fa-list" aria-hidden="true"></i>Liste Gestionnaire</a></li>
                                <li><a class="dropdown-item" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i>Ajouter Gestionnaire</a></li>   
                             </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('administrateur/logout') }}">
    ...
    <div class="container">
        ...
        <a href="{{ route('utilisateur.create') }}" class="btn btn-primary mb-2">Ajouter un Utilisateur</a>
        @if ($users->isEmpty())
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td>{{ $user->email }}</td>
                            <td>
                                <a href="{{ route('utilisateur.edit', $user->id) }}" class="btn btn-sm btn-primary">Modifier</a>
        ...
        @endif
        <a href="{{ url('/exportPDF') }}" class="btn btn-success">Exporter en PDF</a>
