                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('/listeAd') }}"><i class="fa fa-list" aria-hidden="true"></i>Liste Utilisateur</a></li>
                                <li><a class="dropdown-item" href="{{ url('/createAd') }}"><i class="fa fa-user-plus" aria-hidden="true"></i>Ajouter Utilisateur</a></li>   
                             </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
